...
export const EDITOR_CONTEXT_ACTION = {
  VALIDATE: 'VALIDATE',
  FIND_DEVICES: 'FIND_DEVICES',
  SELECT_DEVICE: 'SELECT_DEVICE',
  UNSELECT_DEVICE: 'UNSELECT_DEVICE',
  INSTALL_FIRMATA: 'INSTALL_FIRMATA',
};

export const TASK_DATA = {
  FULL_EDITOR: {
    NAME: 'Full editor',
    TOOLBOX: `<xml id="blokino-toolbox">
    ...
    ACTION_TYPE: EDITOR_CONTEXT_ACTION.VALIDATE,
    SUMMARY: [],
    VARIABLES: ['led_1'],
    CHANNEL: 'FULL_EDITOR',
  },
  ...
  LED: {
    FIRST_TASK: {
      ...
      SUMMARY: [
        {
          label: 'CHALLENGES.LED.TASKS.FIRST.STEPS.TITLE',
          description: 'CHALLENGES.LED.TASKS.FIRST.STEPS.SUMMARY',
          extra: 'CHALLENGES.LED.TASKS.FIRST.STEPS.EXTRA',
        },
      ],
      VARIABLES: ['led_1'],
      CHANNEL: 'channel_one',
    ...
    SECOND_TASK: {
      ...
      SUMMARY: [
        {
          label: 'CHALLENGES.LED.TASKS.SECOND.STEPS.TITLE',
          description: 'CHALLENGES.LED.TASKS.SECOND.STEPS.SUMMARY',
          extra: 'CHALLENGES.LED.TASKS.SECOND.STEPS.EXTRA',
        },
      ],
    },
    ...
    THIRD_TASK: {
      ...
      SUMMARY: [
        {
          label: 'CHALLENGES.LED.TASKS.THIRD.STEPS.TITLE',
          description: 'CHALLENGES.LED.TASKS.THIRD.STEPS.SUMMARY',
          extra: 'CHALLENGES.LED.TASKS.THIRD.STEPS.EXTRA',
        },
      ],
    },
  },
